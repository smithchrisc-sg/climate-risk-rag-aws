#!/usr/bin/env python3
"""
AWS CDK App for Climate Risk RAG System
Microservices serverless architecture with data lake processing pipeline
"""
...
from stacks.textextractor_lambda_stack import TextExtractorLambdaStack
...
# TextExtractor Lambda stack (Lambda functions for document processing)
textextractor_lambda_stack = TextExtractorLambdaStack(
    ...
    env=env,
    description="Lambda functions for async TextExtractor document processing"
)
