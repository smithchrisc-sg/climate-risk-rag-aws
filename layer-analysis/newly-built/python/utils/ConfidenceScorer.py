...
# Optional fuzzywuzzy import for enhanced text similarity
try:
...
class ConfidenceScorer:
    ...
    def _calculate_text_similarity(self, entity_text: str, concept_label: str) -> float:
        ...
        if FUZZYWUZZY_AVAILABLE:
            ...
            similarity = self._simple_string_similarity(entity_text, concept_label)
        
        return similarity
    
    def _simple_string_similarity(self, text1: str, text2: str) -> float:
        """Simple string similarity fallback when fuzzywuzzy is not available"""
        ...
        chars1 = set(text1_lower)
        chars2 = set(text2_lower)
