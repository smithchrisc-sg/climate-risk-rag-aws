#!/usr/bin/env python3
"""
Update Keyword Indexer Lambda Layers
Fixes the Lambda layer configuration for the keyword-indexer function
"""
...
def main():
    ...
    logger.info("🔧 Updating Keyword Indexer Lambda Layers")
    logger.info("==================================================")
    ...
    try:
        ...
        # Use the same layers as the pipeline test function, plus the opensearch layer
        desired_layers = [
            ...
            'arn:aws:lambda:us-east-1:861276078413:layer:opensearch-dependencies:1'
        ]
