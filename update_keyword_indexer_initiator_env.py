#!/usr/bin/env python3
"""
Update Async Keyword Indexer Initiator Environment Variables
Adds the DATABASE_URL environment variable to the async-keyword-indexer-initiator function
"""
...
def main():
    ...
    logger.info("🔧 Updating Async Keyword Indexer Initiator Environment Variables")
    logger.info("==================================================")
