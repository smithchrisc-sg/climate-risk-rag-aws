#!/usr/bin/env python3
"""
Update Lambda Function with Fixed File
Updates the text-chunker-pipeline Lambda function with the fixed text_chunker_processor.py file
"""
...
def main():
    ...
    logger.info("🔧 Updating Lambda Function with Fixed File")
    logger.info("==================================================")
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Copy the fixed file
            logger.info("Copying fixed text_chunker_processor.py file...")
            fixed_file_path = '/Users/chris/climate-risk-rag-aws/text_chunker_processor_fixed.py'
            target_file_path = os.path.join(temp_dir, 'text_chunker_processor.py')
            
            with open(fixed_file_path, 'r') as src_file:
            ...
            logger.info(f"Replaced text_chunker_processor.py with fixed version that properly binds the _split_into_sentences_safe method")
