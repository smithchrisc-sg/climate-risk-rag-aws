...
class TextChunkerProcessor:
    ...
    def _add_safe_sentence_splitting(self):
        ...
        # Define a safe sentence splitting method
        def _split_into_sentences_safe(text: str) -> List[str]:
        ...
        # Replace the method in the structured chunker
        self.structured_chunker._original_split_into_sentences = self.structured_chunker._split_into_sentences
        self.structured_chunker._split_into_sentences = _split_into_sentences_safe.__get__(self.structured_chunker)
